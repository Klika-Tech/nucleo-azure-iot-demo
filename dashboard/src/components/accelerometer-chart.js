    ...
    initChart: function (el) {
        ...
        this.updateChart = function () {
            ...
            markers.selectAll('circle.x')
                .attr('cy', function (d) { return y(d.accelerometer.x) })

            markers.selectAll('circle.y')
                .attr('cy', function (d) { return y(d.accelerometer.y) })

            markers.selectAll('circle.z')
                .attr('cy', function (d) { return y(d.accelerometer.z) })
            ...
            contextMarkers
                ...
                .attr('y2', function (d) { return Math.round(y2(Math.max(d.accelerometer.x, d.accelerometer.y, d.accelerometer.z))) })
        ...
        if (this.props.data === undefined) return <div />
            ...
            return (
                <div className="temperature-chart-container">
                    <h1>Accelerometer Sensor {boardStatus}</h1>
