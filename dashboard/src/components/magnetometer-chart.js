...
const MagnetometerChart = React.createClass({
    ...
    initChart: function (el) {
        ...
        const contextPathGenerator = _.mapValues({ x: null, y: null, z: null }, (v, axis) =>
            d3.svg.line()
                .y(function (d) { return y2(d.magnetometer[axis]) })
        ...
        this.updateChart = function () {
            ...
            markers.selectAll('circle.x')
                .attr('cy', function (d) { return y(d.magnetometer.x) })

            markers.selectAll('circle.y')
                .attr('cy', function (d) { return y(d.magnetometer.y) })

            markers.selectAll('circle.z')
                .attr('cy', function (d) { return y(d.magnetometer.z) })
            ...
            contextMarkers
                ...
                .attr('y2', function (d) { return Math.round(y2(Math.max(d.magnetometer.x, d.magnetometer.y, d.magnetometer.z))) })
        ...
        if (this.props.data === undefined) return <div />
            ...
            return (
                <div className="temperature-chart-container">
                    <h1>Magnetometer Sensor {boardStatus}</h1>
